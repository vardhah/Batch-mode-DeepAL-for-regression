...
N = []; minim=1000; maxim=25000; sample=0
while sample<maxim:
...
if __name__ == "__main__":
        ...
        for n in N:
         ...
         training_data, eval_data=data_split_size(pool_mesh,n)
         print('train size:',training_data.shape,'eval size:',eval_data.shape)
         ...
         lnp_e_m=load_N_predict(fitted_eval_mesh,input_size,output_size,directory,'S')
